...
const PricingCardContent: React.FC<PricingCardProps> = ({
  plan,
  price,
  setPrice,
}) => {
...
export const PricingCard: React.FC<PricingCardProps> = (props) => {
  return (
    <Suspense
      fallback={
        <article className='relative flex flex-col rounded-xl border bg-slate-100 px-8 py-8 shadow-sm text-center min-h-[440px] border-slate-300 animate-pulse'>
          <div className='mt-2 h-6 bg-slate-200 rounded w-3/4 mx-auto' />
          <div className='mt-3 h-16 bg-slate-200 rounded' />
          <div className='mt-6 h-8 bg-slate-200 rounded w-1/2 mx-auto' />
          <div className='mx-auto mt-4 h-6 bg-slate-200 rounded w-2/3' />
          <div className='mt-auto pt-6'>
